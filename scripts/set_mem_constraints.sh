...
## Arbitrary Limit
JAVA_COMPRESSED_CLASS_SPACE_SIZE="${JAVA_COMPRESSED_CLASS_SPACE_SIZE:-32M}"

## Arbitrary Limit
JAVA_MAX_METASPACE_SIZE="${JAVA_MAX_METASPACE_SIZE:-32M}"

## JAVA_RESERVED_CODE_CACHE_SIZE="${JAVA_RESERVED_CODE_CACHE_SIZE:-128M}"

CONTAINER_MAX_MEMORY=${CONTAINER_MAX_MEMORY:-${JAVA_XMX:-$(to_bytes "736M")}}
